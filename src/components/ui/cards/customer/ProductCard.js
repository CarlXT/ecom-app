        ...
        <div className="flex items-center justify-between pt-0.5 sm:pt-1">
          ...
          <div className="flex items-center gap-2 sm:gap-5 text-white shrink-0">
            ...
            <button 
              ...
              type="button"
              className=${`p-1 hover:text-red-400 transition-all focus:outline-none cursor-pointer flex items-center justify-center active:scale-90 ${
                isOutOfStock ? 'opacity-40 cursor-not-allowed hover:text-white' : ''
              }`}
              aria-label="Add to Cart"
            >
              <svg className="w-5 h-5 sm:w-8 sm:h-8 fill-none stroke-current" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

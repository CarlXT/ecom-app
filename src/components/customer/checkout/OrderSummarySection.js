...
export function OrderSummarySection({ cartItems = [], subtotal = 0 }) {
  ...
  return html`
    <div class="lg:col-span-5 bg-[#171719] border border-zinc-800 rounded-3xl p-6 space-y-6 font-['SF_Pro',-apple-system,BlinkMacSystemFont,sans-serif]">
      <h3 class="text-xl font-bold text-white">Your Orders</h3>
      ...
      <div class="border-t border-zinc-800 pt-4 space-y-2 text-sm">
        ...
        <div class="flex justify-between font-extrabold text-xl text-white border-t border-zinc-800 pt-3">
          <span>Total:</span>
          <span>Php ${typeof subtotal === 'number' ? subtotal.toFixed(2) : subtotal}</span>
        </div>
      </div>
